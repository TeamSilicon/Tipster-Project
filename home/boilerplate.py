            ...
            if s.ratio() > 0.5:
                if SequenceMatcher(None, zulu_arr[each][1], stat_arr[each2][1]).ratio() > 0.6:
                    ...
                    if stat_arr[each2][3].strip() != "-:-":
                        ...
                        res = zulu_arr[each][3]
                    success_compr.append([zulu_arr[each][0], zulu_arr[each][1], "%s,%s" % (
                        zulu_arr[each][2], stat_arr[each2][2]), res, stat_arr[each2][4], zulu_arr[each][5], zulu_arr[each][6], stat_arr[each2][7]])
